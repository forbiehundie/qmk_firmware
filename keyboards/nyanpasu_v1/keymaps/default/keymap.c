...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_ESC,     KC_A,        KC_AS,       KC_CD,           KC_SF,         KC_G,            KC_KP_4,    KC_KP_5,    KC_KP_6,         KC_H,       KC_SJ,      KC_CK,      KC_AL,      KC_SCOLON,  KC_QUOTE,  \
		KC_LSHIFT,	KC_Z,        KC_X,        KC_C,            KC_V,          KC_B,            KC_KP_1,    KC_KP_2,    KC_KP_3,         KC_N,       KC_M,       KC_COMMA,   KC_DOT,     KC_SLASH,   KC_SFTENT, \
		KC_LCTRL,   KC_LGUI,     KC_LALT,     KC_NUMLOCK,             KC_S1,                   KC_KP_0,    KC_KP_DOT,  KC_SFTENT,             KC_S2,            KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT
		),
    [_FN1] = LAYOUT(
